      ...
      <div >
        <div class="mt-5 d-flex flex-column justify-content-center align-items-center">
            ...
            <div class="d-flex mb-3 justify-content-between align-items-center container" style="margin-top:100px">
                <router-link to="/offres" style="cursor: pointer;" class="d-flex align-items-center">
                ...
                <p class="text-center h2 fw-bold text-uppercase ">À propos de l'offre</p>
                <p></p>
            </div>
            ...
            <div class="shadow container p-4 details-container">
                <div class="">
                    <img :src=" '/storage/'+offre.photo" alt="" class="w-100" style="height: 600px; width:100%; " >
                    <div class="d-flex flex-column mt-5">
                        <h3 class="rosette-text-green pb-4">{{ offre.titre }}</h3>
                        <div class=" d-flex justify-content-between mt-2">
                            <p>Inscription du: <span class="fw-bold">{{ formatDate(offre.debut_inscription) }} au {{ offre.fin_inscription }} </span> </p>
                            <p>Publié le: <span class=" fw-bold">{{ formatDate(offre.debut_formation) }} </span></p>
                        </div>
                ...
                <div class="d-flex justify-content-center align-items-center action-button">
                    <router-link :to="{ name:'subscribe', params: { id: offre.id }}" class="btn btn-primary px-5 rounded-pill me-3">Postuler</router-link>
...
<script>
    ...
    export default {
        ...
        created(){
            ...
            this.$url.get('offres/'+route.params.id).then(response =>{
