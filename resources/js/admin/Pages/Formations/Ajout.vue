                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><router-link to="/admin/formations/liste">Ajouter formations</router-link></li>
                        </ol>
                    </div>
                </div>
    ...
    export default {
        ...
        methods: {
            ...
            store(){
                ...
                this.$url.post('formations',formData).then(response => {
                    ...
                    toastr.success('Formation ajoutée avec succès !', {timeOut: 3000})
                })
